...
public class WxPayTest {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             * 扫码支付 返回二维码连接
             */
            result = WxPay.nativePay(System.currentTimeMillis() + "", "1", mchId, "测试", null, null, null, null, null, null, null, null, null, key);
            ...
            /**
             * 小程序支付（跳转） 不是真正的下单，组装参数。拿到参数后使用小程序的前端将参数传递给支付收银小程序
             */
            ...
            /**
             * 小程序支付，真正的下单，返回小程序支付所需参数（废弃，建议使用 WxPay.minAppPayV3）
             */
            minAppPay = WxPay.minAppPaySend("o-_-itxeWVTRnl-iGT_JJ-t3kpxU", System.currentTimeMillis() + "", "0.01", mchId, "小程序支付演示", null, null, null, null, null, null, null, key);
            System.out.println("小程序支付结果：" + minAppPay.toJSONString());

            /**
             * 原生小程序支付 minAppPayV3
             */
            minAppPay = WxPay.minAppPayV3(System.currentTimeMillis() + "", "0.01", mchId, "小程序支付演示", "o-_-itxeWVTRnl-iGT_JJ-t3kpxU", "wxa12356wejkcjaskjfie", null, null, null, null, null, null, key);
            System.out.println("小程序支付结果：" + minAppPay.toJSONString());
             ...
             * 微信h5支付
             */
            String h5payResult = WxPay.H5Pay(System.currentTimeMillis() + "", "0.01", mchId, "H5支付测试，仅限企业", null, null, null, null, null, null, null, null, key);
