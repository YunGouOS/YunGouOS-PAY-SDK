...
public class FinanceTest {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 生成分账账单： 首先明白一个前提，分账是针对订单的，也就意味着必须要有一个已支付的订单号。有了订单号那么我们需要知道这个订单给谁分多少钱？
		 * 即该接口的作用，针对订单和配置单号，系统计算出相关金额以及分账接收方数据，同一笔订单支持多个收款人分账，也就是多个配置单号，使用,号分割。
		 * 
		 * 分账支付：
		 * 有了分账账单了，账单已经计算好分多少钱，分给谁那么下面干什么？当然是进行付款的动作了，即调用该接口告诉微信，我要进行分账付钱了。
		 * 
		 ...
		 */
		String configNo = Finance.config(mch_id, "测试分账", "wxpay", "o-_-itxeWVTRnl-iGT_JJ-t3kpxU", null, null, null, "0.12", null, key);
